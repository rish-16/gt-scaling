...
if __name__ == '__main__':
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        # TODO: create fake batch of graphs
        fake_N_nodes = 17
        all_fake_graphs = []
        for i in range(BS):
            ...
            new_data = pyg.data.Data(
                            x=fake_x, 
                            y=fake_y, 
                            edge_attr=fake_edge_attr, 
                            edge_index=fake_edge_idx, 
                            EigVals=torch.rand(fake_N_nodes, 8, 1),
                            EivVecs=torch.rand(fake_N_nodes, fake_N_nodes - 1),
