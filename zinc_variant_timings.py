...
SMALL_BIGBIRD_PATH_TRAIN = "/Users/rish/Desktop/UROP/gt-scaling/results/variants/zinc-subset-GPSsmall-RWSE-LapPE-BigBird/agg/train/best.json"
...
plt.show()
plot.get_figure().savefig("figures/tradeoff/zinc_test_inf_time_all_models.pdf", format="pdf")